                ...
                <div className="bg-[#EFEEEA] p-6 rounded-2xl border border-[#595959] shadow-sm space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-3 py-1 rounded-lg bg-[#595959] hover:bg-[#A30B1A] text-[#EFEEEA] text-xs font-bold transition flex items-center gap-1 cursor-pointer"
                      >
                        <Copy className="w-3.5 h-3.5" /> Copy Code
                      </button>
                    </div>

                    <pre className="bg-[#595959] p-4 rounded-xl text-xs font-mono text-[#EFEEEA] overflow-x-auto leading-relaxed border border-[#595959]">
                  ...
                  <div className="space-y-2 pt-2">
                    ...
                    <textarea
                      ...
                      className="w-full p-4 bg-[#EFEEEA] border border-[#595959] rounded-xl text-xs font-mono text-[#595959] outline-none focus:border-[#D60303]"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-[#595959]/20">
                    <div className="flex items-center gap-2">
                      {subState.status === 'VERIFIED' ? (
                        <span className="px-3 py-1 rounded-full bg-[#A30B1A] text-[#EFEEEA] text-xs font-bold flex items-center gap-1">
                          <CheckCircle2 className="w-4 h-4" /> VERIFIED & LOCKED ({subState.marks} Marks)
                        </span>
                      ) : subState.status === 'SUBMITTED' ? (
                        <span className="px-3 py-1 rounded-full bg-[#C23D31] text-[#EFEEEA] text-xs font-bold flex items-center gap-1">
                    ...
                    <button
                      ...
                      disabled={isSubmitting || subState.status === 'VERIFIED'}
                      className="px-6 py-2.5 rounded-xl bg-[#D60303] hover:bg-[#A30B1A] disabled:opacity-50 text-[#EFEEEA] text-xs font-bold shadow-md transition flex items-center gap-1.5 cursor-pointer"
                    >
